...
def get_config(config_str='B'):
  ...
  #    'B': 'gs://labeling-datasets/magvit_jax/2dvq_imagenet/10/dir10/imagenet_2d_base',
  #    'L': 'gs://magvit/models/imagenet_2d_large',
  #}[version]
  config.init_from.checkpoint_path = '/workspace/v2/magvit/videogvt/dir10/checkpoint_427032'
