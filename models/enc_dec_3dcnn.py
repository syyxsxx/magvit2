...
class Encoder(nn.Module):
  ...
  def setup(self):
    ...
    self.custom_conv_padding = self.config.vqvae.get('custom_conv_padding', 'constant')
  ...
  def __call__(self, x, *, is_train=False):
    ...
    print("xxxxxxxxx----input_shape-----xxxxxxxxxx")
    print(x.shape)
    return x
      ...
      for i in reversed(range(num_blocks)):
        ...
        if i > 0:
          ...
          if self.upsample == 'deconv':
            ...
            print("#############1#################")
            print(x.shape)
            print("t_stridet_stridet: ", t_stride)
            x = conv_fn(filters * 4 * t_stride, kernel_size=(3, 3, 3))(x)
            print("#############2#################")
            print(x.shape)
            b, t, h, w = x.shape[:-1]
            print("#############3#################")
            print("fuckkkkkk:", b, t, h, w)
            print(filters)
